...
- Name: simple-form.spec.ts >> Simple Form Demo >> Validate entered message
- Location: tests/simple-form.spec.ts:17:7
...
- generic [ref=e3]:
  ...
  - contentinfo [ref=e73]:
            ...
            - list [ref=e81]:
              ...
              - listitem [ref=e86]:
                - link "Kane CLI" [ref=e87] [cursor=pointer]:
                  - /url: /kane-cli/
              - listitem [ref=e88]:
                - link "Agent to Agent Testing" [ref=e89] [cursor=pointer]:
              ...
              - list [ref=e228]:
                ...
                - listitem [ref=e265]:
                  - link "Contact Us" [ref=e266] [cursor=pointer]:
                    - /url: /contact-us/
              - generic [ref=e267]: What's New
              - list [ref=e268]:
                - listitem [ref=e269]:
                  - link "Gartner® Magic Quadrant™ Report" [ref=e270] [cursor=pointer]:
                    - /url: /gartner-magic-quadrant-ai-augmented-software-testing-tools/
                - listitem [ref=e271]:
                  - link "Coding Jag - Issue 293" [ref=e272] [cursor=pointer]:
                    - /url: /newsletter/editions/issue293/
                - listitem [ref=e273]:
                  - link "March'26 Updates" [ref=e274] [cursor=pointer]:
                    - /url: /blog/march-2026-updates/
        - generic [ref=e275]:
          - generic [ref=e276]:
            - generic [ref=e277]:
              - img [ref=e278]
              - paragraph [ref=e299]: Deliver unparalleled digital experience with our Next-Gen, AI-Native testing cloud platform. Ensure exceptional user experience across all devices and browsers.
            - generic [ref=e300]:
              - link "Start free Testing White Arrow White Arrow" [ref=e301] [cursor=pointer]:
                - /url: /register/
                - text: Start free Testing
                - generic [ref=e302]:
                  - img "White Arrow" [ref=e303]
                  - img "White Arrow" [ref=e304]
              - button "Book a Demo" [ref=e305] [cursor=pointer]
          - generic [ref=e306]:
            - generic [ref=e307]:
              - paragraph [ref=e308]: Summarize with AI
              - generic [ref=e309]:
                - link "ChatGPT Icon" [ref=e310] [cursor=pointer]:
                  ...
                  - img "ChatGPT Icon" [ref=e311]
                - link "Perplexity Icon" [ref=e312] [cursor=pointer]:
                  ...
                  - img "Perplexity Icon" [ref=e313]
                - link "Claude AI Icon" [ref=e314] [cursor=pointer]:
    ...
    - generic [ref=e357]:
      - generic [ref=e358]: © 2026 TestMu AI. All rights reserved.
      - generic [ref=e359]:
...
```ts
  ...
  2  | 
  3  | export class SimpleFormPage {
  4  | 
  5  |   constructor(private page: Page) {}
  6  | 
  7  |   async open() {
  8  |     await this.page.goto('/selenium-playground/');
  9  |     await this.page.getByText('Simple Form Demo').click();
  10 |   }
  11 | 
  12 |   async enterMessage(message: string) {
> 13 |     await this.page.locator('#user-message').fill(message);
     |                                              ^ Error: locator.fill: Error: strict mode violation: locator('#user-message') resolved to 3 elements:
  14 |   }
  15 | 
  16 |   async clickGetCheckedValue() {
  17 |     await this.page.getByRole('button', { name: 'Get Checked Value' }).click();
  18 |   }
  19 | 
  20 |   async getDisplayedMessage() {
  21 |     return this.page.locator('#message');
  22 |   }
  23 | }
  24 | 
```